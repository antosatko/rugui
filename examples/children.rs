...
impl ApplicationHandler for App {
    fn resumed(&mut self, event_loop: &winit::event_loop::ActiveEventLoop) {
        ...
        let mut bg = Element::new(&gui).with_label("hello element");
        let bg_styles = &mut bg.styles;
        bg_styles.transfomr_mut().margin = Size::Percent(10.0);
        bg_styles.set_bg_color(Color::CYAN);

        let mut gray_screen = Element::new(&gui).with_label("gray screen");
        let gray_styles = &mut gray_screen.styles;
        gray_styles.transfomr_mut().margin = Size::Percent(25.0);
        gray_styles.set_bg_color(Color::BLACK.with_alpha(0.8));

        let mut rows = Element::new(&gui).with_label("rows");
        let mut row1 = Element::new(&gui).with_label("row1");
        let mut row2 = Element::new(&gui).with_label("row2");
        let row1_styles = &mut row1.styles;
        row1_styles.transfomr_mut().rotation = Rotation::Percent(90.0);
        row1_styles.set_bg_color(Color::RED);
        let row2_styles = &mut row2.styles;
        row2_styles.set_bg_color(Color::GREEN);
        ...
        let mut column1 = Element::new(&gui).with_label("column1");
        let mut column2 = Element::new(&gui).with_label("column2");
        let mut column3 = Element::new(&gui).with_label("column3");
        ...
        column1_styles.set_bg_color(Color::RED);
        let column2_styles = &mut column2.styles;
        column2_styles.set_bg_color(Color::GREEN);
        let column3_styles = &mut column3.styles;
        column3_styles.set_bg_color(Color::BLUE);
